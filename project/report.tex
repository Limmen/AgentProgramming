...
\begin{figure}[H]
  \begin{center}
    \scalebox{0.70}{
      \includegraphics{artquoter_role.pdf}
    }
    \caption{ArtQuoter role}
    \label{fig:artquoter_role}
  \end{center}
\end{figure}
\begin{figure}[H]
  \begin{center}
    \scalebox{0.70}{
      \includegraphics{curatorbuyer_role.pdf}
    }
    \caption{CuratorBuyer role}
    \label{fig:curatorbuyer_role}
  \end{center}
\end{figure}
