...
I've assumed the mobile architecture that I used for homework 3, i.e that only artistmanager agents and curator agents are mobile and can close themself. Further more the cardinality of agents and places also follow from this assumption.
\end{assumption}
\begin {table}[H]
...
\par \setlength\parindent{14pt} Description: 
\par \setlength\parindent{14pt} Origin: 
\par \setlength\parindent{14pt} Final Destination: 
\par \setlength\parindent{14pt} List of atomic movements:
\\
\par \setlength\parindent{44pt}\fbox{%
    \parbox{300pt}{%
\hspace{10pt} 1 \hspace{15pt} \vrule  \hspace{10pt} Description
    }%
}
\\
\setlength\parindent{14pt} \noindent\rule{15cm}{0.4pt}
