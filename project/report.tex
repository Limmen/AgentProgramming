...
\begin{figure}[H]
  \begin{center}
    \scalebox{0.55}{
      \includegraphics{curator_state.pdf}
    }
...
In this task the different agents are modelled with a flavor of UML class diagrams that is presented here: \citep{class_diagram}.
...
\citep{jade} \citep{jack} \citep{fipaos} \citep{agentdk}
